...
corte** e o rodapé fique sempre **abaixo** do último confronto (sem sobreposição). A altura
SHALL ter um **piso** que preserve o formato aproximadamente quadrado das rodadas pequenas.
O número de confrontos desenhados SHALL ter um teto suficiente para uma rodada de liga com
20 clubes (10 jogos) e fases de grupos; confrontos além do teto SHALL ser indicados por um
rodapé "+N confrontos".
