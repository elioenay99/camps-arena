...
O sistema SHALL prover `getTournamentClassificacao` que busca o torneio (com regras) e as partidas com nomes embutidos, executa o motor e devolve as linhas com nome resolvido. Torneio não retornado pela RLS SHALL resultar em `null`; falha de query SHALL lançar erro amigável.
