...
falhar nem bloquear sua resposta, e SHALL ser sempre aguardado antes de qualquer
redirecionamento. O conteúdo da notificação SHALL conter apenas dados que o destinatário
já pode ver (é co-participante) e SHALL incluir uma URL de destino. Quando as chaves
VAPID não estiverem configuradas, o envio SHALL ser um no-op silencioso.
